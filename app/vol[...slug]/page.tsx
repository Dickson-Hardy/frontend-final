        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground mb-6">
            <div className="flex items-center gap-1">
              ...
              <span>Published: {finalArticle.publishDate ? format(new Date(finalArticle.publishDate), 'MMMM d, yyyy') : 'Not published'}</span>
            </div>
            <div className="flex items-center gap-1">
              <FileText className="w-4 h-4" />
              <span>Volume: {finalArticle.volume?.volume || volumeNumber}</span>
            </div>
            <div className="flex items-center gap-1">
